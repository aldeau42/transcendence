...
class Program {
    constructor(renderer, {
        ...
        this.defaultFsCode = this.parent.type === "Plane" ? planeFS$1 : shaderPassFS$1;
 ...
 ***/
class PingPongPlane extends Plane {
...
const flattenDefaultParams = (params) => {
...
var script$5 = {
  ...
  setup(props, { emit }) {
    ...
    vue.provide("curtainsEvents", curtainsEvents);

    const params = flattenDefaultParams(props.params);
    // instanciate curtains right away
    const curtains = vue.shallowReactive(new Curtains(params));
    vue.provide("curtains", vue.readonly(curtains));
    ...
    vue.onMounted(() => {
      ...
      Object.keys(curtainsEvents.subscriptions).forEach((subscription) => {
        curtains[subscription](() => {
          emit(curtainsEvents.kebabCase[subscription], vue.toRaw(curtains));
          curtainsEvents.subscriptions[subscription].forEach((element) => {
            element.callback && element.callback(vue.toRaw(curtains));
          });
        });
      });
    });
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    vue.createElementVNode("div", vue.mergeProps({ ref: "container" }, _ctx.$attrs), null, 16 /* FULL_PROPS */),
    vue.renderSlot(_ctx.$slots, "default")
  ], 64 /* STABLE_FRAGMENT */))
}

script$5.render = render$4;
script$5.__file = "src/vue-curtains/components/Curtains/index.vue";

let curtainsInstance;

function useCurtains(callback = () => {}) {
  let isMounted = false;
  const curtains = vue.inject("curtains", null);
  ...
  if (curtainsInstance) {
    ...
    vue.watch(
      ...
      async (container) => {
        if (container) {
          curtainsInstance = vue.toRaw(curtains);
          launchCallback();
        }
      },
      { immediate: true }
...
function useCurtainsEvent(event, callback = () => {}) {
  const curtainsEvents = vue.inject("curtainsEvents");
...
var script$4 = {
  ...
  setup(props, { emit }) {
    ...
    const planeEl = vue.ref(null);

    const renderTarget = vue.inject("renderTarget", null);
    ...
    vue.watch(
      ...
      (newValue) => {
        if (newValue.value) {
          setRenderTarget(vue.toRaw(newValue.value));
        }
      },
      { deep: true }
    );
...
const _hoisted_1$1 = { ref: "planeEl" };
...
script$4.__file = "src/vue-curtains/components/Plane/index.vue";
...
var script$3 = {
  ...
  setup(props, { emit, slots }) {
    ...
    if (props.autoDetectChildren) {
      ...
      vue.provide("renderTarget", vue.readonly(renderTarget));
      vue.provide("uniqueKey", props.uniqueKey);
    }
...
script$3.__file = "src/vue-curtains/components/RenderTarget/index.vue";
...
var script$2 = {
  ...
  setup(props, { emit }) {
    ...
    const renderTarget = vue.inject("renderTarget", null);
    const parentRTKey = vue.inject("uniqueKey", null);
      ...
      if (curtains) {
        ...
        if (existingShaderPass.length) {
          ...
          if (renderTarget && renderTarget.value) {
            params.renderTarget = vue.toRaw(renderTarget.value);
          }
...
script$2.__file = "src/vue-curtains/components/ShaderPass/index.vue";
...
script$1.__file = "src/vue-curtains/components/PingPongPlane/index.vue";
...
script.__file = "src/vue-curtains/components/FXAAPass/index.vue";

exports.Curtains = script$5;
exports.FXAAPass = script;
exports.PingPongPlane = script$1;
exports.Plane = script$4;
exports.RenderTarget = script$3;
exports.ShaderPass = script$2;
exports.useCurtains = useCurtains;
exports.useCurtainsEvent = useCurtainsEvent;
